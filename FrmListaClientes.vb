...
Public Class FrmListaClientes
    ...
    Private Sub BtnNuevo_Click(sender As Object, e As EventArgs) Handles BtnNuevo.Click
        ...
        FrmNuevoEditarCliente.Text = "Registrar nuevo cliente"
        FrmNuevoEditarCliente.ShowDialog()
    End Sub

    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        '
        If DgvListaClientes.RowCount = 0 Then MsgBox("No se puede EDITAR los datos del cliente." & Chr(13) & "Agrega un NUEVO registro, para buscar, editar o eliminar." _
                                                     , vbInformation, "Editar datos del cliente") : BtnNuevo.Focus() : Exit Sub
        '
        'FrmNuevoEditarCliente.MdiParent = FrmPrincipal
        FrmNuevoEditarCliente.Text = "Modificar datos del cliente"
