...
Public Class A_modify_A
    ...
    Private Sub A_modify_A_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TxtNomCli_GotFocus(sender As Object, e As EventArgs)
    ...
    Private Sub TxtNomCli_KeyPress(sender As Object, e As KeyPressEventArgs)
        'SOLO LETRAS
    End Sub

    Private Sub TxtNomCli_LostFocus(sender As Object, e As EventArgs)

        TxtLostFocus(TxtNomCli) 'LLAMAMOS A LA FUNCION TxtLostFocus Y LE PASAMOS LA CADENA DEL TxtNomCli
    End Sub

    Private Sub TxtNomCli_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub TxtApeCli_GotFocus(sender As Object, e As EventArgs)
    ...
    Private Sub TxtApeCli_KeyPress(sender As Object, e As KeyPressEventArgs)
        'SOLOLETRAS
    End Sub

    Private Sub TxtApeCli_LostFocus(sender As Object, e As EventArgs)

        TxtLostFocus(TxtApeCli) 'LLAMAMOS A LA FUNCION TxtLostFocus Y LE PASAMOS LA CADENA DEL TxtApeCli
    End Sub

    Private Sub TxtApeCli_TextChanged(sender As Object, e As EventArgs)
    ...
    Private Sub DtpFdnCli_GotFocus(sender As Object, e As EventArgs)
        TxtEdaCli.BackColor = Color.Azure
    End Sub

    Private Sub DtpFdnCli_LostFocus(sender As Object, e As EventArgs)
        TxtEdaCli.BackColor = Color.Beige
        If TxtEdaCli.Text = "" Then TxtEdaCli.BackColor = Color.MistyRose
    End Sub

    Private Sub DtpFdnCli_ValueChanged(sender As Object, e As EventArgs)
        '
        TxtEdaCli.Text = Int(DateDiff("m", DtpFdnCli.Value, Now) / 12) & " años"
    End Sub

    Private Sub TxtTlfCli_GotFocus(sender As Object, e As EventArgs)
        TxtTlfCli.BackColor = Color.Azure
    End Sub

    Private Sub TxtTlfCli_KeyPress(sender As Object, e As KeyPressEventArgs)
        'SOLO NÚMEROS
    End Sub

    Private Sub TxtTlfCli_LostFocus(sender As Object, e As EventArgs)
        TxtLostFocus(TxtTlfCli)
    End Sub

    Private Sub TxtTlfCli_TextChanged(sender As Object, e As EventArgs)
        'CODIGO PARA BUSCAR
    End Sub

    Private Sub TxtEmlCli_GotFocus(sender As Object, e As EventArgs)
        TxtEmlCli.BackColor = Color.Azure
    End Sub

    Private Sub TxtEmlCli_KeyPress(sender As Object, e As KeyPressEventArgs)
        'NO SABEMOS QUE HACER
    End Sub

    Private Sub TxtEmlCli_LostFocus(sender As Object, e As EventArgs)
        TxtLostFocus(TxtEmlCli)
    End Sub
    Private Sub TxtEmlCli_TextChanged(sender As Object, e As EventArgs)
        'COMPROBAR SI ES UN CORREO CORRECTO
    End Sub

    Private Sub TxtDirCli_GotFocus(sender As Object, e As EventArgs)
        TxtDirCli.BackColor = Color.Azure
    End Sub

    Private Sub TxtDirCli_KeyPress(sender As Object, e As KeyPressEventArgs)
        'COMPROBAR
    End Sub

    Private Sub TxtDirCli_LostFocus(sender As Object, e As EventArgs)
        TxtLostFocus(TxtDirCli)
    End Sub

    Private Sub TxtDirCli_TextChanged(sender As Object, e As EventArgs)
        'PENSAREMOS PARA QUE NOS PUEDE SERVIR
    End Sub

    Private Sub DgvListCli_CellClick(sender As Object, e As DataGridViewCellEventArgs)
